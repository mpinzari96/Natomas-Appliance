...
export default function RootLayout({
  ...
  // Check if the current path is /cta
  const isCTAPage = typeof window !== "undefined" && window.location.pathname === "/cta"

  // If it's the CTA page, just render the children without the layout
  if (isCTAPage) {
    return children
  }
